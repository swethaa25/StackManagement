...
public class EmployeeController {
	...
	public String addinstance(@ModelAttribute("instance") Instance instance,Model model)
	{
	...
	public String deleteinstance(@ModelAttribute("instance") Instance instance,Model model)
	{
		instrepo.delete(instance);
		List<Instance> instances=instrepo.findAll();
		model.addAttribute("instance", instances);
		return "home";
	}
